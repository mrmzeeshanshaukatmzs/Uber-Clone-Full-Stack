...
const ConfirmRidePopUp = (props) => {
 ...
 <div className='flex flex-col justify-between items-center gap-2'>
  ...
  <div className='btns mt-6 w-full'>
 <form onSubmit={(e)=>{
    submitHandler(e)
 }}>
    <input
    ...
    onChange={(e)=> setotp(e.target.value)}
     className='bg-[#eee] px-6 py-4 font-mono rounded-lg w-full mt-5' type="text" placeholder='Enter OTP' />
 <Link to='/captain-riding'
    className='mt-5 text-lg w-full flex justify-center bg-green-600 text-white font-semibold p-2 rounded-lg'>Confirm</Link>
    ...
    className='mt-5 text-lg w-full bg-red-500 text-white font-semibold p-2 rounded-lg'>Cancel</button>
 </form>
  </div>
